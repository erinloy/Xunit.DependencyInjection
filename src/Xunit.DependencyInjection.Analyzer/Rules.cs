...
public static class Rules
{
    ...
    private static LocalizableResourceString CreateLocalizableString(string key) => new LocalizableResourceString(key, AnalyzerResources.ResourceManager, typeof(AnalyzerResources));
